...
// Clientes — agrega foto URL cuando las tengas, o deja photo:null para iniciales
const CLIENTS = [
    { id:1, name:'Cliente 1', photo:null },
    { id:2, name:'Cliente 2', photo:null },
    { id:3, name:'Cliente 3', photo:null },
    { id:4, name:'Cliente 4', photo:null },
    { id:5, name:'Cliente 5', photo:null },
    { id:6, name:'Cliente 6', photo:null },
];
...
const TESTIMONIALS = [
    {
        id:1,
        quote:'Entregó el proyecto antes de tiempo y la calidad superó todas mis expectativas. Definitivamente volvería a trabajar con él.',
    ...
    {
        id:2,
        quote:'Excelente manejo del color grading y los motion graphics. Le dio exactamente el look cinematográfico que buscábamos.',
        name:'Otro Cliente',
    ...
    {
        id:3,
        quote:'Muy profesional, se comunicó perfectamente durante todo el proceso y el resultado final fue increíble.',
        name:'Tercer Cliente',
...
function saveVideos() {
    localStorage.setItem(STORAGE_KEY, JSON.stringify(videos.filter(v => v.source === 'admin')));
}
...
function renderSlider() {
    ...
    const list = videos.length ? videos : [{
        id:0, title:'Agrega tu primer video',
        category:'youtube', ytId:null,
        description:'Abre el panel admin (clic 3 veces en la esquina inferior derecha) y agrega un link de YouTube.'
    }];
...
function showAdminTab(name) {
    $('tab-add').style.display    = name==='add'    ? 'block' : 'none';
    $('tab-manage').style.display = name==='manage' ? 'block' : 'none';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (heroBg) {
        ...
        img.src = 'https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=1800&q=85&auto=format&fit=crop&crop=center';
    }
